...
{	
	...
	this.drawCannon = function()
	{
		...
		context.save();
			...
			context.lineTo(this.x + this.width/2, this.y - this.height/1.2);
			context.lineTo(this.x - this.width/2, this.y - this.height/1.2);
			context.fill();
		context.restore();
	...
	this.drawRightCannon = function()
	{
		...
		context.save();
			...
			context.beginPath();
			context.moveTo(this.x, this.y);
			context.lineTo(this.x + this.width/1.2, this.y - this.height/2);
			context.lineTo(this.x + this.width/1.2, this.y + this.height/2);
			context.fill();
		context.restore();
